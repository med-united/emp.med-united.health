 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://ws.gematik.de/conn/ConnectorCommon/v5.0}WorkplaceId" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class WorkplaceIds {
     ...
     * This is why there is not a <CODE>set</CODE> method for the workplaceId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWorkplaceId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getWorkplaceId() {
        if (workplaceId == null) {
            workplaceId = new ArrayList<String>();
        }
