...
@XmlRootElement(name = "CardTerminals")
public class CardTerminals {

    @XmlElement(name = "CardTerminal")
    protected List<CardTerminalInfoType> cardTerminal;
     ...
     * This is why there is not a <CODE>set</CODE> method for the cardTerminal property.
     * 
     * <p>
     ...
     * 
     */
    public List<CardTerminalInfoType> getCardTerminal() {
        if (cardTerminal == null) {
            cardTerminal = new ArrayList<CardTerminalInfoType>();
        }
